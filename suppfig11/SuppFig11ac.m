%% Main
%SUPPFIG11AC generates data for supplementary figure 11a,c and is written 
...
n = 1912; %number of nodes
md = 32.7395;
eta = 1.19;

alpha = 0.8; %attributing parameter
nd = 192; %number of data points
rs = linspace(0,1,nd); %number of rebels
rs = floor(rs.*n);

IC = -ones(n,1); %set initial choices

nrp = 100; %number of repeats
