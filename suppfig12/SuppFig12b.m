%% Main
%FIG2B generates data for figure 2b and is written for running on 
%clusters.
...
nd = 25; %number of data points
ks = linspace(1,25,nd); %generate data points for mu 
mds = ks.*2;
beta = 0.15;
